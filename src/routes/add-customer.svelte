<html lang="en"
	><head>
		...
		<link href="./_app/immutable/assets/html_head.5b4f3774.css" rel="stylesheet" /><title
			>Dashboard</title
	...
	<body data-sveltekit-preload-data="hover">
		<div style="display: contents">
			<section id="body">
				<div class="flex h-screen bg-white-50">
					<aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
						<div class="py-4 text-gray-500">
							<img class="ml-6 text-lg font-bold text-gray-800" src="/images/logo.png" alt="Base" />
							<ul class="mt-6">
								<li class="relative px-6 py-3">
									...
									/>
									<a
										class="text-gray-800 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800"
										href="/"
										><svg
											class="w-5 h-5"
											aria-hidden="true"
					...
					<div class="flex flex-col flex-1 w-full bg-[#FAFAFB]">
						<main class="h-full overflow-y-auto">
							<div class="container px-6 mx-auto grid">
								<div class="flex justify-between items-center">
									<h2 class="my-6 text-2xl font-semibold text-black-700">Dashboard</h2>
									<div class="flex space-x-4">
										<div class="ml-auto">
											<select
												id="tanggal"
												name="tanggal"
												class="mt-1 block w-32 p-2 border rounded-md bg-white"
											>
										...
										<table class="w-full whitespace-no-wrap">
											<thead
												><tr
													...
													><th class="px-4 py-3">Client</th> <th class="px-4 py-3">Amount</th>
													<th class="px-4 py-3">Status</th> <th class="px-4 py-3">Date</th></tr
												></thead
											>
												...
												><tr class="text-gray-700 "
													...
													<td class="px-4 py-3 text-xs"
														><span
															...
															>Approved</span
														></td
													> <td class="px-4 py-3 text-sm">6/10/2023</td></tr
												>
												<tr class="text-gray-700 "
													><td class="px-4 py-3"
														><div class="flex items-center text-sm">
